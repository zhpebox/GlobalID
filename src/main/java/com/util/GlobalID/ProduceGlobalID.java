...
public class ProduceGlobalID {
	
	/**
	 * 由时间戳(12)+机器码(12)+随机数(4)生成28位随机数，以BigDecimal形式输出
	 * 如果获取机器码失败，会根UUID生成16位随机码代替(机器码(12)+随机数(4))
	 * @return BigDecimal
	 */
	public static BigDecimal generateRandomId(){
